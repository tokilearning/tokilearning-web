        ...
        <div class="drow">
            ...
            <span class=""><?php echo CHtml::activeDropDownList($submission, 'verdict',
                    array(
                        ...
                        'Forbidden syscall' => 'Forbidden syscall', 'Forbidden file access' => 'File access forbidden',
...
<div id="answer" class="section2">
    ...
    <div class="dtable">
        ...
        <div class="drow">
            <span class="name">Waktu Pengumpulan</span>
            <span><?php echo $submission->submitted_time; ?></span>
        </div>
        <div class="drow">
            <span class="name">Jumlah jawaban gagal</span>
            <span><?php echo $prev_subs; ?></span>
        </div>
        <div class="drow">
