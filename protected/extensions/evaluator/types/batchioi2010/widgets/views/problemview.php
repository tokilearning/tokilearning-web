...
<div class="submit-form-wrapper">
    ...
    <div>
        <?php echo Yii::t('contest', 'Format berkas kode yang tersedia');?>: <br />
        <ul>
    ...
    <div style="display:table">
        <div style="display:table-row">
            <div style="display:table-cell;padding:3px;"><strong><?php echo Yii::t('contest', 'Kode Jawaban'); ?></strong></div>
    ...
    <input type="submit" name="Submission[submit]" value="<?php echo Yii::t('contest', 'Kumpul');?>" />
...
<div class="button" style="float:right">
    <?php echo CHtml::link(Yii::t('contest', 'Perbesar'), '?action=enlarge', array('target' => '_blank')); ?>
</div>
