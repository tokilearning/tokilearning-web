...
$this->widget('CTabView',
        array(
            'tabs' => array(
                'display' => array(
                    'title' => 'Tampilan',
                    'view' => 'ext.evaluator.types.archive.widgets.views.problemupdate.description',
                    'data' => array(
                        'problem' => $problem,
                ...
                'configuration' => array(
                    ...
                    'view' => 'ext.evaluator.types.archive.widgets.views.problemupdate.configuration',
                    'data' => array(
                        'problem' => $problem,
                    )
                ),
...
//                ),
                'files' => array(
                    'title' => 'Berkas',
                    'view' => 'ext.evaluator.types.archive.widgets.views.problemupdate.files',
                    'data' => array(
                        'problem' => $problem,
                    )
                ),
