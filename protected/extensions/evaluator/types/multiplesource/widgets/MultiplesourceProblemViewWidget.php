...
class MultiplesourceProblemViewWidget extends CWidget {
        ...
        if (!$this->submitLocked) {
            if (isset($_POST['Submission'])) {
                ...
                try {
                    ...
                    $archive = new MultiplesourceArchive();
                    $archive->submission_id = $this->submission->id;
                    $archive->file = $filecontent;
                    $archive->save();
